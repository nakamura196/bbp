    ...
    <v-container>
      <v-row>
        <v-col cols="12" sm="9">
          <v-row>
            <v-col>
              <h3>{{((page - 1) * size + 1).toLocaleString()}} - {{(page * size > total ? total : page * size).toLocaleString()}} of {{total.toLocaleString()}} results</h3>
            </v-col>
            <v-col></v-col>
          </v-row>
          ...
          <template v-if="results.hits">
            ...
            <v-card class="my-5" v-for="(obj, i) in results.hits.hits" :key="i">
              <v-row>
                <v-col cols="12" sm="4">
                  <v-card-text>
                    <a target="blank" :href="obj.item.value">
                ...
                <v-col cols="12" sm="8">
                  <v-card-title>
                    <a target="blank" :href="obj.item.value">{{obj.label.value}}</a>
                  </v-card-title>
                  <v-card-text>
                    <p v-if="obj.description">
                      <b>Description:</b>
        ...
        <v-col cols="12" sm="3">
          <template v-if="results.aggregations">
            <v-card class="my-5" v-for="(obj, index) in results.aggregations" :key="index">
